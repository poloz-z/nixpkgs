  ...
  services.polybar = {
    ...
    config = {
      ...
      "bar/top" = {
        ...
        font-0 = "FuraCode Nerd Font:size=13;3";
        font-1 = "FuraCode Nerd Font:style=Bold:size=13;3";

        modules-left = "distro-icon dulS ddrT i3 dulT";
        modules-center = "title";
        modules-right = "durT audio ddlT a  date2";
      ...
      "bar/bottom" = {
        ...
        modules-left = "powermenu ddlT a cmus ddlS";

        modules-right = "ddrT eth dulT ddrS cpu dulS ddrT memory"; 
#dulT ddrP info";
      ...
      "module/date2" = {
        ...
        format-prefix-background = secondary;
      ...
      "module/eth" = {
        ...
        format-connected-prefix-foreground = secondary;
        label-connected = "%local_ip%";
        label-connected-foreground = secondary;
        label-connected-background = tertiary;
      };

      "module/cmus" = {
        type = "custom/script";
        exec = "/home/polo/.config/nixpkgs/cmus.sh";
